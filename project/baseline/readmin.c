...
{                                       
    ...
    printf( "alloc for nodes       KB %3d\n", 
            (long)((net->n + 1)*sizeof(node_t) / 0x400) );
    printf( "alloc for dummy arcs  KB %3d\n", 
            (long)((net->n)*sizeof(arc_t) / 0x400) );
    printf( "alloc for arcs        KB %3d\n", 
            (long)((net->max_m)*sizeof(arc_t) / 0x400) );
    printf( "----------------------------\n" );
    printf( "heap about            KB %3d\n\n", 
            (long)((net->max_m)*sizeof(arc_t) / 0x400),
            +(long)((net->n)*sizeof(arc_t) / 0x400),
            +(long)((net->max_m)*sizeof(arc_t) / 0x400)
            );
